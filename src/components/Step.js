...
export const Step = ({ title, text }) => {
    ...
    return (
        <div className="w-[70rem] max-lg:w-[50rem] max-md:w-[30rem]">
            <div className="group bg-secondary text-primary p-8 flex justify-between hover:brightness-90 cursor-pointer max-md:p-4" onClick={() => setOpen((open) => !open)}>
