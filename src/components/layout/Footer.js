    ...
    return (
        <div>
            <div className='footer bg-[black]'>
                ...
                <div className='payment border-t border-[#3e3e3e]' >
                    ...
                    <div className=''>
                        <span className='copyright text-[white] text-[10px] mt-[10px] ml-[50px]'>
                            @ 2023,
                            <a
                                href="/"
                                className="text-[white] text-[10px] bg-none rounded-md shadow hover:text-indigo-200 "
                            >
                                MatrixAIMovement
                            </a>
                        </span>
