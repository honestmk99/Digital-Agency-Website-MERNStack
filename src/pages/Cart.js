                ...
                {+window.localStorage.count > 0 ? (<>
                    <div className="text-[rgb(196,113,245)] font-primary">
                        ...
                        <div className="grid grid-cols-4 font-ft-secondary">
                            ...
                            <h2 className="text-2xl font-thin tracking-widest py-5 col-span-1 max-md:text-xl">QUANTITY</h2>
                            <h2 className="text-2xl font-thin tracking-widest py-5 col-span-1 text-right max-md:text-xl">TOTAL</h2>
                        </div>
